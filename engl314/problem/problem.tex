...
\begin{document}
  ...
  \noindent On August 25, 1991 a man named Linus Torvalds posted a message announcing his new creation. It was a free kernal that was developed to mimic the behavior of the very popular UNIX terminal.
  ...
  kernal started to sprout up, and iterations continue to be developed to this day, the most famous being the Android platform which runs 38\% of computers in the world(Operating System Market 2017).\\

  \noindent Due to the open nature of development this operating system is easy for knowlagable people to take apart and rebuild to better fit the needs of a user.
  ...
  This class also comes later in the program after most students have already become attached to a development environment, causing a reluctancy to adopt a new system. This course

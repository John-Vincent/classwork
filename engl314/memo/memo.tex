...
\memoto{James Vincent} % Recipient(s)

\memofrom{Brian Burmeister} % Sender(s)

\memosubject{Seniors preparing for a career in Software Engineering} % Memo subject

\memodate{Monday, August 28, 2017} % Date, set to \today for automatically printing todays date

...
public interface Value {
	...
	static class FunVal implements Value { //New in the funclang
      ...
      public boolean equals(Object o){
        //should just test if objects are the same reference
	...
	static class NumVal implements Value {
      ...
      public boolean equals(Object o){
        if(o instanceof NumVal){
          return ((NumVal)o)._val == this._val;
        }
        return false;
      }
	}
	static class BoolVal implements Value {
      ...
      @Override
      public boolean equals(Object o){
        return o instanceof BoolVal && ((BoolVal)o)._val == this._val;
      }
	}
	static class StringVal implements Value {
      ...
      @Override
      public boolean equals(Object o){
        return o instanceof StringVal && ((StringVal)o)._val.equals(this._val);
      }
	}
    ...
    @Override
    public boolean equals(Object o){
      return o instanceof PairVal && ((PairVal)o)._fst.equals(this._fst) && ((PairVal)o)._snd.equals(this._snd);
    }
	}

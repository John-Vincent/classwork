...
public class Evaluator implements Visitor<Value> {
	...
	@Override
	public Value visit(PredExp e, Env env) {
      ...
      case "list?":
          return new BoolVal(val instanceof Value.PairVal && ((Value.PairVal)val).snd() instanceof Value.PairVal);
    }
    return new DynamicError("predicate type not recognized");
	}

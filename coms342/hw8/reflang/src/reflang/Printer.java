...
public class Printer {
    ...
    public String visit(AST.ArrayAssignExp e, Env env){
      List<Exp> i = e.getIndex();
      String r = "(assign ";
      r += e.getArray().accept(this, env);
      for(Exp ex : i){
        r += ex.accept(this, env);
      }
      r += e.getValue().accept(this, env);
      return r + ")";
    }

    public String visit(AST.ArrayExp e, Env env){
      List<Exp> list = e.getDimensions();
      String r = "(array ";
      for(Exp ex : list){
        r += ex.accept(this, env);
      }

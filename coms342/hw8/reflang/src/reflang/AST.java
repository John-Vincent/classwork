...
public interface AST {
    ...
    public static class ArrayExp extends Exp {
      ArrayList<Exp> dim;
      public ArrayExp(ArrayList<Exp> dim){
        this.dim = dim;
      }
      public ArrayList<Exp> getDimensions(){
        return this.dim;
      }
      public Object accept(Visitor visitor, Env env) {
    		return visitor.visit(this, env);
    ...
    public static class ArrayAssignExp extends Exp {
      Exp array;
      Exp val;
      ArrayList<Exp> list;
      public ArrayAssignExp(Exp array, ArrayList<Exp> list, Exp value){
        this.array = array;
        this.list = list;
        this.val = value;
      }
    ...
    public static class IndexExp extends Exp {
      Exp array;
      ArrayList<Exp> list;
      public IndexExp(Exp array, ArrayList<Exp> list){
        this.array = array;
        this.list = list;
      }
      public Exp getArray(){
    ...
    public T visit(AST.ArrayAssignExp e, Env env);
	}
}

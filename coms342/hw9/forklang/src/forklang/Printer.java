...
public class Printer {
	...
	public static class Formatter implements AST.Visitor<String> {
		...
		public String visit(AST.LetrecExp e, Env env) {
			...
			return result + ")";
				...
				public String visit(LockExp e, Env env) {
                    String result = e.isBlocking() ? "(lock " : "(lock? ";
                    result += e.value_exp().accept(this, env);
                    return result + ")";
				}
        ...
        @Override
        public String visit(SyncExp e, Env env){
          String result = "(synchronized ";
          result += e.getLock().accept(this, env) + " " + e.getCrit().accept(this, env);
          return result + ")";
        }
